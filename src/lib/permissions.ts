...
const PERMISSION_ALIASES: Record<string, string[]> = {
  ...
  'kitchen.view': ['kitchen.view', 'kitchen.read', 'kitchen.access', 'pos.access', 'orders.view', 'orders.read'],
  ...
  'reports.view': ['reports.view', 'reports.read', 'orders.view', 'orders.read', 'analytics.view', 'analytics.read', 'pos.access', 'kitchen.view', 'crm.view'],
